...
var ms2 = 0;
var ms2temp = 0;
$(".timer").html("Timer: " + m1 + m2 + ":" + s1 + s2 + ":" + ms1 + ms2);
...
function myTimer() {
    ms2temp += 100. / timestepFactor;
    ms2 = Math.round(ms2temp);
...
function graphCheck() {
    if (document.getElementById("showgraphs").checked == true) {
        ...
        } else if (windowWidth > 900) $(".selectors").css("transform", "translateY(-300px)");
